...
def xml_to_ChooseWaveformParams_array(fname, minrow=None, maxrow=None,
    ...
    """
    print fname
    xmldoc = utils.load_filename( fnam , LIGOLWContentHandler )
    try:
...
def get_psd_series_from_xmldoc(fname, inst):
    return read_psd_xmldoc(utils.load_filename(fname , LIGOLWContentHandler))[inst]  # return value is pylal wrapping of the data type; index data by a.data[k]
